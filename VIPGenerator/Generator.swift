...
protocol \(prefix)RouterInterface: AnyObject {
...
final class \(prefix)Presenter {
    ...
    init(
        interactor: \(prefix)InteractorInterface,
        router: \(prefix)RouterInterface,
        view: \(prefix)ViewControllerInterface
      ) {
        self.view = view
...
protocol \(prefix)InteractorInterface: AnyObject {
